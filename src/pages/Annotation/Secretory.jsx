...
export default class GO extends React.Component {
  ...
  fetchResults() {
    ...
    axios
      .get(
        `${env.BACKEND}/api/secretory/?species=${species}&page=${currentPage}&size=${perPage}`
      )
      .then((res) => {
    ...
    return (
      <div className="container">
        ...
        <div className="row flex-lg-row justify-content-center g-2 my-2">
          <h5><b> <i>P. striiformis</i> ({spp}) Secretory Proteins </b></h5>
          <Divider />
        </div>
        ...
        <div className="row flex-lg-row justify-content-center g-2 my-2">
          ...
          type="text"
          placeholder="Search example: POW08146, PSTT_04635"
          value={searchQuery}
