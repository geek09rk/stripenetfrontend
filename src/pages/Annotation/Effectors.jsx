  ...
  fetchResults() {
    ...
    axios
      .get(
        ...
        `${env.BACKEND}/api/effectors/?species=${species}&page=${currentPage}&size=${perPage}`
      )
      .then((res) => {
    ...
    return (
      <div className="container">
        ...
        <div className="row flex-lg-row justify-content-center g-2 my-2">
          <h5><b> <i>P. striiformis</i> ({spp}) Effectors </b></h5>
          <Divider />
        </div>
        ...
        <div className="row flex-lg-row justify-content-center g-2 my-2">
          ...
          type="text"
          placeholder="Search example: POW18011, apoplastic"
          value={searchQuery}
