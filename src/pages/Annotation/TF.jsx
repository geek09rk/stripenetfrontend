...
export default class GO extends React.Component {
  ...
  fetchResults() {
    ...
    axios
      .get(
        `${env.BACKEND}/api/tf/?species=${species}&page=${currentPage}&size=${perPage}`
      )
      .then((res) => {
    ...
    return (
      <div className="container">
        ...
        <div className="row flex-lg-row justify-content-center g-2 my-2">
          <h5><b> {spp} Transcription factors </b></h5>
          <Divider />
        </div>
        ...
        <div className="row flex-lg-row justify-content-center g-2 my-2">
          ...
          type="text"
          placeholder="Search example: TraesCS1A02G372300.1.cds1"
          value={searchQuery}
